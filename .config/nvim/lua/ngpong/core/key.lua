  ...
  local builtin_keymaps = {
    ...
    },
    {
      ...
      maps = {
        ...
        { "<ctrl-b>cc", "delete selected buffer", mode_n },
        { "<ctrl-b>c,", "delete buffers left", mode_n },
        { "<ctrl-b>c.", "delete buffers right", mode_n },
    ...
    },
    {
      ...
      maps = {
        { "<ctrl-f>f", "open file picker", mode_n },
        { "<ctrl-f>g", "open grep picker", mode_n },
        { "<ctrl-f>G{search}", "open grep picker with {search}", mode_n },
        { "<ctrl-f>d", "open document diagnostic picker", mode_n },
        { "<ctrl-f>D", "open workspace diagnostic picker", mode_n },
        { "<ctrl-f>m", "open bookmark picker", mode_n },
        { "<ctrl-f>s", "open lsp-symbols picker", mode_n },
        { "<ctrl-f>S", "open treesitter picker", mode_n },
        { "<ctrl-f>b", "open buffer picker", mode_n },
        { "<ctrl-f>r", "restore last close picker", mode_n },
        { "<ctrl-f>/", "open lines picker", mode_n },
        { "<ctrl-f><leader>", "open picker selector", mode_n },
    ...
    },
    {
      ...
      maps = {
        { "<ctrl-t>t", "open troublelist selector", mode_n },
        { "<ctrl-t>m", "open bookmark list", mode_n },
        { "<ctrl-t>f", "open picker list", mode_n },
        { "<ctrl-t>b", "open buffer list", mode_n },
        { "<ctrl-t>d", "open document diagnostic list", mode_n },
        { "<ctrl-t>D", "open workspace diagnostic list", mode_n },
        { "<ctrl-t>s", "open lsp-symbols list", mode_n },
