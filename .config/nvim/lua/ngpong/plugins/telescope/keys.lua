...
local set_plugin_keymaps = function()
  return {
    n = {
      ...
      ['<'] = wrap_keymap(this.api.scroll_result(-1, 3), { desc = 'scrolling pageup result entries.' }),
      ['>'] = wrap_keymap(this.api.scroll_result(1, 3), { desc = 'scrolling pagedown result entries.' }),
