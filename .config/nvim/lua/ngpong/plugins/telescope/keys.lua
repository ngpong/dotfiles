...
local set_plugin_keymaps = function()
  return {
    n = {
      ...
      ['V'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ['v'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ...
      ['<BS>'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ['z'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ['e'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ['e;'] = wrap_keymap(this.api.actions.nop, { desc = 'which_key_ignore' }),
      ...
      ['<'] = wrap_keymap(this.api.scroll_result(-1, 3), { desc = 'TELESCOPE: scrolling pageup result entries.' }),
      ['>'] = wrap_keymap(this.api.scroll_result(1, 3), { desc = 'TELESCOPE: scrolling pagedown result entries.' }),
...
local set_native_keymaps = function()
  ...
  keymap.register(e_mode.VISUAL, 'fs', 'y<C-c><ESC>\\lua require("telescope").extensions.live_grep_args.live_grep_args({ default_text="<C-r>0" })<cr>', { silent = true, desc = 'which_key_ignore' })
  -- keymap.register(e_mode.VISUAL, 'fs', '<C-c><ESC>\\lua require("telescope").extensions.live_grep_args.live_grep_args({ default_text="<C-r>0" })<cr>', { silent = true, desc = 'which_key_ignore' })
