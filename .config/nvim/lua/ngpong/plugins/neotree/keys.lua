...
local set_global_keymaps = function(...)
  return {
    ...
    ['<leader>c']  = { command = 'ngpong_nop_map', desc = 'which_key_ignore' },
    ...
    ['<C-CR>']     = { command = 'toggle_preview', desc = 'NEOTREE: preview selected node.', config = { use_float = true } },
    ['<S-CR>']     = { command = 'toggle_node', desc = 'NEOTREE: toggle selected node.', config = { use_float = true } },
...
local set_filesys_keymaps = function(...)
  return {
    ...
    ['fc']    = { command = 'copy_to_clipboard', desc = 'copy file.' },
    ['fv']    = { command = 'paste_from_clipboard', desc = 'paste file.' },
