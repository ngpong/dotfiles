...
M.setup = function()
  ...
  vim.api.nvim_set_hl(0, 'TroubleFilename', { fg = colors.light1 })
  vim.api.nvim_set_hl(0, 'TroublePos', { fg = colors.dark3 })
  vim.api.nvim_set_hl(0, 'TroubleDirectory', { fg = colors.light1 })
