...
local del_buffer_keymaps = function(bufnr)
  ...
  keymap.register({ e_mode.NORMAL, e_mode.VISUAL }, '<leader>J', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e1', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e2', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e3', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e4', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e5', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e1.', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e1,', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e2.', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
  keymap.register(e_mode.NORMAL, 'e2,', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
