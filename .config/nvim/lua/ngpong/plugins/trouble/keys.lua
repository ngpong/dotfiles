...
local del_buffer_keymaps = function(bufnr)
  ...
  keymap.register(e_mode.NORMAL, '<leader>c', this.api.actions.nop, { buffer = bufnr, desc = 'which_key_ignore' })
...
local set_buffer_keymaps = function(bufnr)
  ...
  keymap.register(e_mode.NORMAL, '<C-CR>', this.api.actions.toggle_preview, { remap = false, buffer = bufnr, desc = 'TOUBLE: toggle preview with selected entry.' })
