...
local del_native_keymaps = function(_)
  ...
  Keymap.unregister(e_mode.NORMAL, ':')
  Keymap.unregister(e_mode.COMMAND, '<A-o>')
  Keymap.unregister(e_mode.COMMAND, '<A-l>')
  Keymap.unregister(e_mode.COMMAND, '<C-p>')
...
local set_native_keymaps = function()
  ...
  Keymap.register(e_mode.COMMAND, '<C-[>', Tools.wrap_f(Helper.feedkeys, '<UP>'), { remap = false, desc = 'which_key_ignore' })
  Keymap.register(e_mode.COMMAND, '<C-]>', Tools.wrap_f(Helper.feedkeys, '<DOWN>'), { remap = false, desc = 'which_key_ignore' })
  ...
  Keymap.register(e_mode.INSERT, '<C-H>', '<DEL>', { remap = false, desc = 'which_key_ignore' })
