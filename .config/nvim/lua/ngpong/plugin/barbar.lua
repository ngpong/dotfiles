...
return {
  ...
  keys = {
    ...
    { "<C-b>c", khelper.pick_delete },
    { "<C-b><C-c>", khelper.pick_delete },
    { "<C-b>'", khelper.delete_right },
    { "<C-b><C-'>", khelper.delete_right },
    { "<C-b>;", khelper.delete_left },
  ...
  highlights = {
    ...
    { "BufferCurrentPin", bg = vim.__color.dark1 },
    { "BufferCurrentPinBtn", bg = vim.__color.dark1 },
    ...
    { "BufferInactivePin", bg = vim.__color.dark0 },
    { "BufferInactivePinBtn", bg = vim.__color.dark0 },
