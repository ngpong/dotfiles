return {
  {
    ...
    keys = {
      { "<C-t>t", function() vim.cmd("Trouble") end, },
      { "<C-t><C-t>", function() vim.cmd("Trouble") end, },
      { "<C-t>d", function() vim.__trouble:open("document_diagnostics") end, },
      { "<C-t><C-d>", function() vim.__trouble:open("document_diagnostics") end, },
      { "<C-t>D", function() vim.__trouble:open("workspace_diagnostics") end, },
      { "<C-t><C-D>", function() vim.__trouble:open("workspace_diagnostics") end, },
      { "<C-t>b", function() vim.__trouble:open("buffers") end, },
      { "<C-t><C-b>", function() vim.__trouble:open("buffers") end, },
      { "<C-t>m", function() vim.__trouble:open("bookmarks") end, },
      { "<C-t><C-m>", function() vim.__trouble:open("bookmarks") end, },
      { "<C-t>f", function() vim.__trouble:open("snacks_picker") end, },
      { "<C-t><C-f>", function() vim.__trouble:open("snacks_picker") end, },
      { "<C-t>s", function() vim.__trouble:open("symbols") end, },
      { "<C-t><C-s>", function() vim.__trouble:open("symbols") end, },
    },
    opts = {
      auto_close = false,
